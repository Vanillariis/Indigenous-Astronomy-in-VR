Shader "Custom/ShaderBaked"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float2 uv : TEXCOORD0;
                float2 uvLM : TEXCOORD1; // ✅ Lightmap UVs to frag
            ...
            Varyings vert(Attributes IN)
            {
                ...
                OUT.uvLM = IN.lightmapUV; // ✅ Pass lightmap UVs
                return OUT;
            }
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                // ✅ Sample baked lighting
                half3 bakedGI = SampleLightmap(input.uvLM, N);

                float3 lightingResult = bakedGI;
                ...
                lightingResult = shadowAttenuation * LightingDesert(N, viewDir, lightDir, input.worldPos, mainLight.color, mainLight.distanceAttenuation, input.tangentWS, input.bitangentWS);
                ...
                float fogFactor = ComputeFogFactor(viewDir);
                half3 fogColor = unity_FogColor;

                half3 finalColors = lerp(finalColor, fogFactor, fogColor);

                return half4(finalColors, 1.0);
            }
